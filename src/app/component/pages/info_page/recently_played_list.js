...
return (
    <div
    id="recently_played_list"
    className="custom-scrollbar p-4 ml-6 rounded-md overflow-y-auto w-full max-w-lg"
    ...
    {recentTracks.length > 0 ? (
        ...
        {recentTracks.map((item, index) => (
            <li
            key={item.id + index}
            className="bg-[#212121] rounded-lg p-3 flex items-center space-x-4"
            >
            <img
                src={item.image}
                alt={item.name}
